...
public class ExtjsTreeNode {
	...
	private List<ExtjsTreeNode> children = new ArrayList<ExtjsTreeNode>(0);

	public ExtjsTreeNode(String id, String href, String iconCls, String text,
	...
	public void addChildren(ExtjsTreeNode node) {
